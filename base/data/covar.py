...
class GeneExpressionDatasetCovar(Dataset):
    '''
    ...
    def __init__(self, mrna_data, mirna_data, anno, label_position=-1, color_position = -2, 
        ...
        self.cancer_type = anno["cancer_type"].values
